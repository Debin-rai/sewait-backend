**SewaIT -- Phase 1 Requirements & Documentation**
...
**Suggested Tech Stack for SewaIT Phase 1**
...
-   SewaIT.com.np/calendar

-   SewaIT.com.np/weather
...
This document is **full Phase 1 documentation** for **SewaIT**.
...
This stack will let your **SewaIT app** be **secure, scalable,
SEO-friendly, and ready for Phase 1**.
1. Technical SEO: The "Speed and Indexing" Edge
To outshine a "heavy" app like HamroPatro, SewaIT focuses on being "Simpler, Cleaner, and Faster".
...
• Clean URL Structure: Use simple, keyword-rich URLs like SewaIT.com.np/calendar or SewaIT.com.np/gold instead of complex strings.
...
• Title Tags & Meta Descriptions: Every page should have a unique title, such as <title>Nepali Calendar & Festivals Today | SewaIT</title>, and a description that encourages clicks by mentioning festivals, weather, and rates.
...
• Sitemap: Generate a sitemap.xml and submit it to Google Search Console to ensure every page of SewaIT is discovered.
